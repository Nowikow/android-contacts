...
public class FilterContactTypeUi implements ListDiffInterface<FilterContactTypeUi> { //имплементация интерфейса для сравнения
    ...
    public boolean theSameAs(FilterContactTypeUi newItem) {
        return this.getContactType() == newItem.getContactType(); //сравнение старого и нового объектов
    }
