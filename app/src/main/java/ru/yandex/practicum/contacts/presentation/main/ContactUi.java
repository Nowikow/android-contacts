...
public class ContactUi implements ListDiffInterface<ContactUi> { //имплементация интерфейса для сравнения
    ...
    public boolean theSameAs(ContactUi newItem) {
        return this.hashCode() == newItem.hashCode(); //сравнение старого и нового объектов
    }
