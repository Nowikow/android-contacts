...
public class SortTypeUI implements ListDiffInterface<SortTypeUI> { //имплементация интерфейса для сравнения
    ...
    public boolean theSameAs(SortTypeUI newItem) {
        return this.getSortType() == newItem.getSortType(); //сравнение старого и нового объектов
    }
